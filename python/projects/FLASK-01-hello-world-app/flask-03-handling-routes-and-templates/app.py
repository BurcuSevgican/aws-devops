...
@app.route('/admin')
def admin():
    return redirect(url_for('error'))  # we write function name inside of parantesis 
# Create a function named greet which return formatted inline html string 
# and assign to the dynamic route of ('/<name>')
@app.route('/<name>')     # we can create without html file # when we <   > it is dynamic route,path name can be change whatever we write 
                          # f """ means dynamic format
#def greet(name):
#    greet_format=f"""   
#<!DOCTYPE html>
#<html>
